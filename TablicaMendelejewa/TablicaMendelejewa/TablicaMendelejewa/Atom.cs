    ...
    internal class Atom
    {
        ...
        public Grid Display(int size)
        {
            ...
            if (size == 6)
            {
                ...
                Siatka.Height = 200;
                Siatka.Width = 150;
                Siatka.Padding = new Thickness(10);
                Siatka.CornerRadius = new CornerRadius(15);
                Siatka.BorderThickness = new Thickness(0, 0, 3, 5);
        ...
        private void MouseHoverOff(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
        ...
        private void MouseHoverOn(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            Grid Siatka = (Grid)sender;
            Siatka.Background = new SolidColorBrush(Windows.UI.Color.FromArgb(255,150,255,255));
